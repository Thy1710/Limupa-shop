...
@section('title','Chi Tiết Sản Phẩm | KTShop')
@section('content')
                                ...
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item"  data-gall="myGallery">
                                            <img src="{{asset('backend/uploaded/'.$product->image)}}" alt="product image">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="old-price new-price-2"><s>{{number_format($product->price)}}đ</s></span>
                                        <br>
                                        <span class="new-price new-price-2">{{number_format($product->price-($product->price*$product->promotion)/100)}}đ</span>
                                    </div>
