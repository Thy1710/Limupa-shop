...
@section('title', 'Trang Chủ | KTShop')
@section('content')
            ...
            <div class="col-lg-12">
                <div class="li-product-tab">
                    <ul class="nav li-product-menu">
                        <li><a class="active"><span>Hot</span></a></li>
                        <!-- <li><a data-toggle="tab" href="#li-bestseller-product"><span>Bán Chạy</span></a></li>
                        <li><a data-toggle="tab" href="#li-featured-product"><span>Mới Nhất</span></a></li>
                    </ul> -->
                </div>
                                ...
                                <div class="single-product-wrap">
                                    <div class="product-image">
                                        <a href="single-product.html">
                                            <img src="{{asset('backend/uploaded/' . $item->image)}}"
                                    ...
                                    <div class="product_desc">
                                        <div class="product_desc_info">
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span
                                                    class="new-price new-price-2">{{number_format($item->price - ($item->price * $item->promotion) / 100)}}đ</span>
                                                <span class="old-price">{{number_format($item->price)}}</span>
                                                <span class="discount-percentage">-{{$item->promotion}}%</span>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="add-actions-link">
                                                <li class="add-cart active">
                                                    <form action="{{ route('add-cart') }}" method="post">
                                                        ...
                                                        <button type="submit" class="btn btn-link p-0" style="text-decoration: none; color: #000000;">Thêm giỏ hàng</button>
                                                    </form>
                                                </li>
                        ...
                        @foreach ($bestsellerProducts as $item)
                            <div class="col-lg-12">
                                ...
                                <div class="single-product-wrap">
                                    ...
                                    <div class="product_desc">
                                        <div class="product_desc_info">
                                            <h4><a class="product_name" href="single-product.html">{{$item->name}}</a>
                                            </h4>
                                            <div class="price-box">
                                                <span
                                                    class="new-price new-price-2">{{number_format($item->price - ($item->price * $item->promotion) / 100)}}đ</span>
                            ...
                            <div class="product-active owl-carousel">
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/11.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/7.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/9.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/5.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                            ...
                            <div class="product-active owl-carousel">
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/3.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="frontend/images/product/large-size/1.jpg"
                                                    alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
