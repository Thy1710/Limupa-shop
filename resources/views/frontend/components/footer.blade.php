                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                ...
                                <p>Bảo vệ người mua của chúng tôi bao gồm việc mua hàng của bạn từ nhấp chuột đến giao
                                    hàng.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                ...
                                <p>Bạn có câu hỏi? Gọi cho Chuyên gia hoặc trò chuyện trực tuyến.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Li's Shipping Inner Box Area End Here -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <ul class="des">
                            <li>
                                <span>Đại Chỉ: </span>
                                Tổ 10, Ấp Hòa Bình, xã Túc Trưng, Huyện Định Quán, Tỉnh Đồng Nai
                            </li>
                            <li>
                            ...
                            <li>
                                <span>Email: </span>
                                <a href="mailto://info@yourdomain.com">phankhanhthy17102003@gmail.com</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="copyright text-center pt-25">
                        <span><a href="https://www.templatespoint.net" target="_blank">@Coppyright by Thy</a></span>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <div class="sm-image"><img src="frontend/images/product/small-size/1.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="frontend/images/product/small-size/2.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="frontend/images/product/small-size/3.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="frontend/images/product/small-size/4.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="frontend/images/product/small-size/5.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="frontend/images/product/small-size/6.jpg"
                                        alt="product image thumb"></div>
                            </div>
                        </div>
                        <!--// Product Details Left -->
