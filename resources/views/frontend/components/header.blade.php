            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="header-top-left">
                        <ul class="phone-wrap">
                            <li>phankhanhthy17102003@gmail.com</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="header-top-right">
                        <ul class="ht-menu">
                            ...
                            <li>
                                @auth
                                @if(Auth::user()->name)
                                    <div class="ht-setting-trigger"><span>Hi, {{Auth::user()->name}}</span></div>
                                ...
                                <div class="language ht-language">
                                    <ul class="ht-setting-list">
                                        <li class="active"><a href="#">
                                                <!-- <img src="images/menu/flag-icon/1.jpg"
                                                alt=""> -->
                                                Tiếng Việt</a></li>
                                        <li><a href="#">
                            ...
                            <li class="hm-minicart">
                                ...
                                <div class="minicart">
                                    ...
                                    <div class="minicart-button">
                                        ...
                                        <a href="{{route('cart')}}" class="li-button li-button-fullwidth">
